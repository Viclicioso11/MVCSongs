...
namespace CancionesConMVC.Migrations
{
    ...
    [Migration("20201002030743_updatingEmployeedata")]
    partial class updatingEmployeedata
    {
            ...
            modelBuilder.Entity("CancionesConMVC.Models.Empleado", b =>
                {
                    ...
                    b.Property<int?>("EmpleadoJefeEmpleadoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EmpleadoJefeEmpleadoId");
            ...
            modelBuilder.Entity("CancionesConMVC.Models.Empleado", b =>
                {
                    b.HasOne("CancionesConMVC.Models.Empleado", "EmpleadoJefe")
                        .WithMany("Empleados")
                        .HasForeignKey("EmpleadoJefeEmpleadoId");
                });
