    ...
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Index(int pagina = 1)
        {
            ...
            var clientes = _context.Clientes
                .Include(cliente => cliente.Empleado)
                .OrderBy(cliente => cliente.Nombres)
                .Skip((pagina - 1) * 5)
                .Take(5)
                .ToList();
        ...
        {
            ViewData["SoporteId"] = new SelectList(_context.Empleados, "EmpleadoId", "EmpleadoId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ClienteId,Nombres,Apellidos,Telefono,Email,SoporteId")] Cliente cliente)
        {
            ...
            ViewData["SoporteId"] = new SelectList(_context.Empleados, "EmpleadoId", "EmpleadoId", cliente.SoporteId);
            return View(cliente);
        }
